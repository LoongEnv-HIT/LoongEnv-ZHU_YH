...
import { Play, CheckCircle2, Monitor, Cpu, Activity, ChevronRight, ChevronLeft, Link, Download, Radio } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6">
          {activeStep === 1 && (
            <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">硬件终端 (Hardware Terminal)</h3>
              ...
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">通信链路 (Communication Links)</h3>
          ...
          {activeStep === 2 && (
            <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center justify-center py-8 text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-[#6f6f6f] max-w-[200px] mx-auto leading-relaxed">
          ...
          {activeStep === 3 && (
            <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <section className="p-4 bg-[#f0fdf4] border border-[#dcfce7] rounded-sm shadow-sm">
              ...
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">控制流 (Control Stream)</h3>
              ...
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">传感器反馈 (Sensor Feedback)</h3>
                <div className="bg-white border border-[#e5e5e5] rounded-sm overflow-hidden shadow-sm divide-y divide-[#f3f3f3]">
