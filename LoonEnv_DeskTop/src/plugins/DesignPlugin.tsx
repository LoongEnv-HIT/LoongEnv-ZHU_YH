...
import { BrainCircuit, Cpu, Layers, ChevronRight, ChevronLeft, CheckCircle2, Play, Activity, BarChart3 } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6">
          {activeStep === 1 && (
            <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">超参数设置 (Hyperparameters)</h3>
              ...
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">计算资源 (Compute Resources)</h3>
              ...
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">网络架构 (Network Architecture)</h3>
          ...
          {activeStep === 2 && (
            <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              ...
              <section>
                <h3 className="text-[10px] font-bold text-[#6f6f6f] uppercase tracking-wider mb-3 px-1">训练实时日志 (Live Training Logs)</h3>
          ...
          {activeStep === 3 && (
            <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 flex flex-col items-center py-2">
              ...
              <div className="text-center">
                ...
                <p className="text-[11px] text-[#6f6f6f] max-w-[200px] mx-auto mt-2 leading-relaxed">
